...
import com.unishare.api.config.cache.EvictMentorCaches;
...
public class MentorServiceImpl implements MentorService {
    ...
    @Cacheable(cacheNames = CacheNames.MENTOR_PROFILE, key = "#mentorId")
    ...
    @Transactional(readOnly = true)
    @Cacheable(
            cacheNames = CacheNames.MENTOR_SEARCH,
            key = "T(com.unishare.api.config.cache.CacheKeys).mentorSearch(#verificationStatus, #keyword, #minBasePrice, #maxBasePrice, #pageable)"
    )
